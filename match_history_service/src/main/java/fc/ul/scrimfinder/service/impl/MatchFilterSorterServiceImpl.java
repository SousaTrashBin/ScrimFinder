...
import fc.ul.scrimfinder.repository.ReadOnlyMatchHistorySearchRepository;
...
public class MatchFilterSorterServiceImpl implements MatchFilterSorterService {
    ...
    @Inject ReadOnlyMatchHistorySearchRepository readOnlyMatchHistorySearchRepository;
    ...
    public PaginatedResponseDTO<MatchDTO> filterSortMatches(
        ...
        PaginatedResponseDTO<Match> matches =
                readOnlyMatchHistorySearchRepository.search(page, size, filterParams);
