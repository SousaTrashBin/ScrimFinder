...
public class MatchFillingResourceTest {
    ...
    public void testGetMatchRawEndpoint() {
        final String path = "/api/v1/external/matches";

        final String matchId = "EUW1_" + UUID.randomUUID();

        when(riotMatchServiceClient.getMatch(anyString()))
                .thenReturn("");

        given()
                .when().get(String.format("%s/%s/raw", path, matchId))
                .then()
                .statusCode(200);
    }
    ...
    public void testGetMatchFillEndpoint() throws JsonProcessingException {
        ...
        final String matchRiotDTO = Json.createObjectBuilder()
                .add("metadata",
                ...
                .add("info",
                        Json.createObjectBuilder()
                                ...
                                .add("participants", Json.createArrayBuilder()
        ...
        final List<PlayerStatsDTO> playerStatsDTOList = List.of(
                new PlayerStatsDTO(
        ...
        final List<TeamStatsDTO> teamStatsDTOList = List.of(
                new TeamStatsDTO(
                        TeamSide.BLUE,
                        27,
                        30,
        ...
        final MatchStatsDTO matchStatsDTO = new MatchStatsDTO(
                matchId,
                1L,
                "15.5",
        ...
        given()
                .when().get(String.format("%s/%s", path, matchId))
                .then()
                .statusCode(200)
