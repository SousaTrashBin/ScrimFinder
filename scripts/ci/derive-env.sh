...
export SCRIM_SECRET_NAME_PREFIX="${SCRIM_SECRET_NAME_PREFIX:-${SCRIM_ENVIRONMENT_NAME}-}"
...
export SCRIM_SECRETS_SERVICE_ACCOUNT_ID="${SCRIM_SECRETS_SERVICE_ACCOUNT_ID:-$derived_secrets_service_account_id}"
...
SCRIM_SECRETS_SERVICE_ACCOUNT_ID=$SCRIM_SECRETS_SERVICE_ACCOUNT_ID
...
SCRIM_MANAGE_CLOUD_FUNCTIONS_IAM=$SCRIM_MANAGE_CLOUD_FUNCTIONS_IAM
EOF
}
