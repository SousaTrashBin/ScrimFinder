...
\begin{document}
    ...
    \begin{itemize}
        \item \bff{Database per Service}: Each microservice (Matchmaking, Ranking, History) maintains its own isolated PostgreSQL database, ensuring data encapsulation and independent scaling.
    ...
    \begin{itemize}
        ...
        \item \bff{Usage}: Indexes detailed match statistics for players and teams, supporting complex filtering.
    \end{itemize}
