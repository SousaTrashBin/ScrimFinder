...
@Tag(name = "Queue Management", description = "Operations for managing queues")
public class QueueController {
    ...
    @POST
    @Path("/{queueId}")
    @Operation(summary = "Creates a queue according to a pre-determined rule, assumes queueId is valid")
    @APIResponses(value = {
    ...
    @PUT
    @Path("/{queueId}")
    @Operation(summary = "Updates an existing queue's configuration")
    @APIResponses(value = {
    ...
    @DELETE
    @Path("/{queueId}")
    @Operation(summary = "Deletes a specific queue")
    @APIResponses(value = {
